    ...
    <>
      ...
      <section className="hero-with-image">
        <div className="absolute inset-0 z-0">
          <Image src={HERO_IMAGES.home} alt="Health4Spain - Spain simplified for foreigners" fill priority fetchPriority="high" sizes="100vw" className="object-cover object-center" />
        </div>
