...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const { data } = await supabase.from('blog_posts').select('title, excerpt, category, published_at, featured_image').eq('slug', slug).eq('status', 'published').eq('lang', 'de').single();
...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      ...
      <div className="container-narrow">
        <div className="prose prose-lg max-w-none blog-article-content" dangerouslySetInnerHTML={{ __html: post.content }} />
